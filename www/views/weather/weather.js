angular.module('App')
.controller('WeatherController', function ($scope, $http, $stateParams, Settings,Locations,
  ...
  // });//livereload时要用这段代码，真机run的时候用下面的代码。
  $http.get('https://api.forecast.io/forecast/e33b593dcdddc5bfaa38a4babc79d95a/' + $stateParams.lat + ',' + $stateParams.lng, {params: {units: Settings.units}}).success(function (forecast) {
    $scope.forecast = forecast;
  });
